                            ...
                            document.getElementById('loginBtn').onclick = function() {
                                ...
                                if (username === "doctor" && password === "12345") {
                                         alert("You have successfully logged in " + username);
                                             window.open("roles/doctor.html");
                                                } else if(username === "pharmacist" && password === "12345"){
                                                         alert("You have successfully logged in " + username);
                                                            window.open("roles/pharmacist.html");
                                                                        }
                                                                        else if(username === "admin" && password === "12345"){
                                                         alert("You have successfully logged in " + username);
                                                            window.open("roles/admin.html");
                                                                        }
                                                                        else if(username === "patient" && password === "12345"){
                                                         alert("You have successfully logged in " + username);
                                                            window.open("roles/patient.html");
                                                                        }
